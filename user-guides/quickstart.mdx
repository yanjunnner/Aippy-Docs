...
Welcome to this step-by-step guide on how to create a full-stack application using Aippy:

### The Aippy Platform Overview
...
<AccordionGroup>
  <Accordion title="Create your First Project">
    ...
    <Steps>
      <Step title="Step 1">
        To get started, head over to [aippy.ai](https://aippy.ai) and create an account.
      </Step>
      <Step title="Step 2">
        Once registered, you'll be able to create your first project.
      </Step>
      <Step title="Step 3">
        Simply enter an initial prompt to kick things off, and Aippy will do the rest\! This is the **starting block** for any project in Aippy, where you can bring your ideas to life instantly.

        ![](/images/Aippy-prompting.png)
      </Step>
    </Steps>
  </Accordion>
  <Accordion title="Aippy Dashboard">
    ...
    At Aippy, simplicity is key:

    - [**Here**](https://aippy.ai/) **you kickstart your project** with a single prompt.
    ...
    - [**Manage your account**](https://aippy.ai/settings) to check monthly credits and adjust settings.
    - **Experiment with** [**Labs**](https://aippy.ai/settings/account) **features** like Chat mode—toggle them on or off.
    - [**Upgrade or downgrade**](https://aippy.ai/settings/plans) **your plan** seamlessly.
  </Accordion>
  <Accordion title="Project Overview">
    ...
    At Aippy, every project follows a structured workflow:
  ...
  <Accordion title="Project Quick Access">
    ...
    - **Log out** securely from your Aippy account.
  </Accordion>
</AccordionGroup>

### Start your Project

There are several ways to get started with Aippy, depending on your preferences and resources:

<AccordionGroup>
  <Accordion title="Prompt">
    Aippy’s prompt-based system makes app creation simple.
  ...
  <Accordion title="Templates">
    <Steps>
      <Step title="Step 1">
        Aippy offers [templates](https://aippy.ai/templates) to help you get started quickly on popular project types, such as dashboards, e-commerce sites, or social apps, for a quick setup.
      </Step>
      <Step title="Step 2">
  ...
  <Accordion title="Using Figma">
    ...
    1. **Using screenshots:** Take a screenshot of any part of it. You can paste the screenshot directly into Aippy or drag-and-drop the image file. Once you press Enter, Aippy will convert your design into functional code.
    2. **Using Builder.io integration:** First, structure your Figma design using Auto-Layout and clear layer naming. Then, open the Builder.io plugin in Figma, select your design, and click "Open in Aippy" to generate a fully functional app. [More information here.](https://aippy.ai/blog/2025-01-22-figma-to-Aippy-builder-io-native-integration)
  </Accordion>
  <Accordion title="Using a Sketch">
    <Steps>
      ...
      <Step title="Step 2">
        Take a screenshot of your drawing, then paste or drag-and-drop it into Aippy.
      </Step>
      <Step title="Step 3">
  ...
  <Accordion title="Cloning a Website or Application">
    ...
    <Steps>
      ...
      <Step title="Step 2">
        Paste or drag the screenshot into Aippy
      </Step>
      <Step title="Step 3">
        Aippy will recreate the structure of the webpage in your project.
      </Step>
    </Steps>
...
<AccordionGroup>
  <Accordion title="Add a Custom Knowledge to your Project">
    The [Knowledge Base](https://docs.aippy.ai/features/precision-edit#knowledge-files) in Aippy acts as your project's **blueprint**, organizing functionality, design, and goals in one place.
  ...
  <Accordion title="Select & Visual Edit">
    [Visual Edits](https://docs.aippy.ai/features/precision-edit#visual-edits) allows AI-driven development with Tailwind-native visual controls for easy refinement.
  ...
  <Accordion title="Connect to GitHub">
    Integrate your project with GitHub to iterate on your application seamlessly. You can make code changes in GitHub or your preferred IDE while keeping everything in sync with Aippy.
    ...
    [More information here](https://docs.aippy.ai/integrations/git-integration).
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Connect a Backend">
    Supabase is a backend-as-a-service platform that integrates smoothly with Aippy to add powerful backend capabilities to your application.
    ...
    <Steps>
      ...
      <Step title="Link to Aippy">
        In Aippy, go to **Settings -\> Connect Supabase** and follow the steps.
      </Step>
  ...
  <Accordion title="Getting Started with Supabase">
    After setting up your Supabase project, you'll need to connect it to your Aippy project. This connection enables Aippy to leverage Supabase's backend services seamlessly.
  ...
  <Accordion title="Streamline Your App's Authentication with Supabase">
    Implementing secure authentication is crucial for any application. With Aippy's AI form builder and Supabase integration, you can effortlessly create robust login and sign-up forms.
    ...
    <Steps>
      ...
      <Step title="Integrate Supabase with Aippy">
        - In Aippy, navigate to the integration settings.​
        - Input your Supabase project URL and API keys to establish a connection.
      </Step>
      <Step title="Design Authentication Forms with Aippy">
        - Use Aippy's AI form builder to craft intuitive login and sign-up forms.​
    ...
    [More information on Supabase here.](https://docs.aippy.ai/integrations/supabase)
  </Accordion>
  <Accordion title="Supabase Edge Functions">
    Enhance your app with Supabase Edge Functions, enabling AI features, payments, and email integration with ease. Follow this guide to build your first full-stack app on Aippy:
  ...
  <Accordion title="Add Payment Capabilities to your Application">
    There are many ways to connect Stripe to Aippy, but the most straight-forward way is to utilize Stripe's built in payment links. [Use this resource to make sure you get this right\!](https://docs.aippy.ai/tips-tricks/setting-up-payments)
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Set up SEO">
    You can check [this section of the documentation](https://docs.aippy.ai/tips-tricks/seo) to ensure all SEO capabilities are properly enabled.
  </Accordion>
  <Accordion title="Add a Custom Domain">
    You can add a custom domain using:

    - Entri (native to Aippy)
    - Netlify
    - Vercel
    - Namecheap

    You can check [this section of the documentation](https://docs.aippy.ai/tips-tricks/custom-domain) for more information.
  </Accordion>
  <Accordion title="Publish my Project">
    ...
    You can refer to [this section of the documentation](https://docs.aippy.ai/features/deploy) for more information.
  </Accordion>
</AccordionGroup>