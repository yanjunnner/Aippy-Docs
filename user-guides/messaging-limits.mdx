...
description: "Understanding daily and monthly message limits for Aippy"
icon: "money-bill-wave"
---

LLMs are expensive, which is why Aippy limits the daily and/or monthly messages that you can send.

## All Plans

- **Daily limit:** 5 free messages per day

Designed to give users a chance to explore and experience Aippy's features at no cost.
...
For detailed information about subscription options, visit our [subscription page](https://Aippy.dev/pricing).
...
<AccordionGroup>
  <Accordion title="Pricing Changes or Charges">
    Aippy sends community and email notifications about any upcoming pricing changes. Please ensure your email is up-to-date in your account settings.
  </Accordion>
