...
description: "Learn how to integrate Make with your Aippy application"
icon: "wand-sparkles"
---
...
- **Trigger actions** from your Aippy app (e.g., when a button is clicked)
...
## Why Use Make with Aippy?

In this below tutorial, Make acts as your **AI-enabled backend**, while Aippy powers the frontend. The result: a custom CRM, built in minutes, fully automated.
...
Building your own CRM can take months. With **Aippy** and **Make**, you can ship one in under an hour — and automate the entire sales workflow without writing backend code. In this step-by-step guide, you’ll learn how to build a **fully functional, AI-powered CRM**, complete with:
...
<Steps>
  ...
  <Step title="Add Deal Stages (Kanban View)">
    ...
    <Steps>
      <Step title="Step 1">
        Open the **Deals** section in Aippy.
      </Step>
      <Step title="Step 2">
  ...
  <Step title="Add Company Data Enrichment with Apollo">
    <Steps>
      ...
      <Step title="Send Request from Aippy">
      ...
      <Step title="Call Apollo.io API">
        ![Apollo Make Aippy Pn](/images/apollo-make-Aippy.png)
  ...
  <Step title="Hide API Calls with Supabase Edge Functions">
    ...
    - Update Aippy to call your Supabase function instead of the direct Webhook.
...
- Use **select \+ prompt** inside Aippy for precision edits
...
<AccordionGroup>
  ...
  <Accordion title="Why use Make with Aippy?">
  ...
  <Accordion title="How does Make communicate with Aippy?">
    Aippy sends data (usually as JSON) via **HTTP webhooks** to Make scenarios. Make receives that data, processes it (e.g., calls an API), and can respond back to Aippy.
  </Accordion>
  ...
  <Accordion title="Can I test my Make Scenarios without Aippy?">
    Yes\! Use **manual data input** in the Webhook or trigger the scenario via Postman or curl. This is great for debugging before connecting to Aippy.
  </Accordion>
</AccordionGroup>
