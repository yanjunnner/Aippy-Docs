---
title: "Integrations"
description: "Extend Aippy functionality with official integrations"
icon: "link"
---

## What is an API?

APIs are essential tools that allow different software systems to communicate. You can refer to [this article on our blog](https://Aippy.dev/blog/2025-01-28-the-power-of-apis). Aippy supports several integrations enabling you to extend its functionality:

## Native Integrations

Explore the sections below to get started quickly and learn more about GitHub, Supabase, Stripe and custom domains integrations currently offered by Aippy.

<CardGroup cols="2">
  <Card title="GitHub Integration" icon="github" href="git-integration">
    Understand how to integrate Aippy with GitHub for seamless version control and collaboration.
  </Card>
  ...
  <Card title="Stripe" icon="stripe" href="https://docs.Aippy.dev/tips-tricks/setting-up-payments">
...
Verified integrations work best with Aippy:

<CardGroup cols="3">
  <Card title="Builder.io" href="https://Aippy.dev/blog/2025-01-22-figma-to-Aippy-builder-io-native-integration">
    [Turn Figma](https://Aippy.dev/blog/2025-01-22-figma-to-Aippy-builder-io-native-integration) designs into full stack applications within Aippy.
  </Card>
  ...
  <Card title="p5.js" href="https://p5js.org/reference/">
    Create creative coding projects and interactive graphics. [Examples](https://x.com/Aippy_dev/status/1869765295931527488) here.
  </Card>
...
You can always request new integrations [here](https://feedback.Aippy.dev/?b=675883fb92175ba92d835f92).
...
View all list of publicly available APIs you can integration with Aippy [here](https://dashboard.mintlify.com/Aippy-f9060f1e/Aippy-f9060f1e/editor/main).