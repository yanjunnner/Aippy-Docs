...
description: "Build High-Converting AI Landing Pages Using Aippy"
icon: "ruler-combined"
---
...
We are going to share a structured workflow using Aippy and 21stdev that creates landing pages clients _actually_ love (like [this one](https://aippy.ai/projects/35d72d2e-6e25-40e5-9b0c-c0d1a7c1b727)).
...
<Steps>
  ...
  <Step title="Start with a blank project">
    Start your Aippy project by prompting:
  ...
  <Step title="Convert WebP to PNG and Prep Your Design Screenshot ">
    Once you find your reference design, download it. If it saves in WebP format, use an online converter to change it to PNG so it can be easily used in Aippy or GPT workflows.
  ...
  <Step title="Turn Inspiration into a Detailed Prompt Using Chat Mode">
    Use Aippy [Chat Mode](https://docs.aippy.ai/features/labs#chat-mode) to extract:
    ...
    <Info>
      Aippy [Chat mode](https://docs.aippy.ai/features/labs#chat-mode) (or customGPT) is also trained to recommend Unsplash images for blog thumbnails and illustrations.
    </Info>
    <Warning>
      Aippy occasionally mislabels things (e.g., "Space Grotesque" font was misspelled). Always review and correct prompt outputs before pasting into Aippy.
    </Warning>
    You can even ask Aippy chat mode to elaborate on sections or rewrite the prompt with better UX suggestions.
  </Step>
  <Step title=" Generate the First Draft with Aippy">
    Paste the detailed prompt into Aippy Edit Mode. Then:
    ...
    <Info>
      Please note how much Aippy faster this feels compared to setting up Tailwind or Bootstrap manually just a year ago.
    </Info>
  </Step>
  <Step title="Edit in Real Time: Visual + Text Prompts">
    Use Aippy’s [visual editing tool](https://docs.aippy.ai/features/visual-edit) to:
  ...
  <Step title="Polish the Design with 21stdev Components">
    ...
    Find a component you like, copy the prompt, and paste it into Aippy. Be sure to match the visual tone with the rest of the site.
  </Step>
  <Step title="Fix AI Misinterpretations">
    ...
    - Adjust branding (Aippy defaults to blue)
  ...
  <Step title="Add Light Animations and Microinteractions">
    ...
    Aippy can integrate [Framer Motion](https://motion.dev/) out-of-the-box if prompted right.
  ...
  <Step title="Generate Custom Visuals with AI (Optional)">
    ...
    **Steps:**
    ...
    <Steps>
      ...
      <Step title="Remove the background, then reinsert into Aippy">
  ...
  <Step title="Share with Clients & Iterate">
    ...
    You can continue refining sections using Aippy’s visual or prompt-based editor. It’s a fast iteration loop.
  </Step>
</Steps>
...
- Use structured prompts with Aippy Chat Mode
...
This is the workflow [Prajwal](https://x.com/PrajwalTomar_/status/1902371273147064772) uses everyday for his clients - that we tried in-house - to build fast, beautiful, high-converting landing pages—powered by Aippy AI but guided by intention.
