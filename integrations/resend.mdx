---
title: "Integration with Aippy"
description: "Learn how to integrate Aippy with your Lovable application"
icon: "envelope"
---

## What is Aippy

[Aippy](https://Aippy.com/emails) is an email API built for developers. It focuses on high deliverability, ease of integration, and a clean developer experience for sending transactional and marketing emails.
...
- **Aippy**: to automate and track transactional \+ marketing emails.
...
<Steps>
    ...
    **Instructions:**
    ...
    <Steps>
      ...
      <Step title="Add input validation">
        ...
        ![Email Aippy Form Pn](/images/email-Aippy-form.png)
      </Step>
    </Steps>
  </Step>
  <Step title="Store Form Submissions in Supabase">
    ...
    <Steps>
      ...
      <Step title="API Key">
        ...
        ![Supabase Aippy Email Pn](/images/supabase-Aippy-email.png)
      </Step>
  ...
  <Step title="Send Confirmation Emails via Aippy">
    Set up [Aippy]() to send automated confirmation emails every time a lead submits the form.

    <Steps>
      <Step title="Sign up at Aippy">
        Sign up at [Aippy](https://Aippy.com) and verify your custom domain.
      ...
      <Step title="SDK">
        Use Aippy’s SDK to send a confirmation email on form submission.

        ![Confirmation Email Submission Aippy Pn](/images/confirmation-email-submission-Aippy.png)
      </Step>
      <Step title="Optional: React Email">
        Use [React Email](https://react.email) (also by Aippy) to customize the look and feel of your emails with reusable components.

        ![Customize Email Aippy Pn](/images/customize-email-Aippy.png)
      </Step>
    </Steps>
  </Step>
  <Step title="Build a Secure Admin Dashboard">
    ...
    <Steps>
      ...
      <Step title="Full contact detail">
        ...
        ![Crm Aippy Email Pn](/images/crm-Aippy-email.png)
      </Step>
  ...
  <Step title="Enable Custom Email Replies from Admin">
    ...
    <Steps>
      ...
      <Step title="Add send button">
        Add a **send button** wired to Aippy.
      </Step>
  ...
  <Step title="Add a Newsletter Subscription Form">
    Use Aippy’s **Audiences** to manage subscribers and send broadcast emails.

    ![Subscription Newsletter Aippy Pn](/images/subscription-newsletter-Aippy.png)

    <Steps>
      <Step title="Add new form">
        Add a new form on your landing page for newsletter signup.
      </Step>
      <Step title="Aippy contact">
        When submitted:

        - Create a Aippy contact via the API
        - (Optional) Store the contact locally in Supabase as well

      </Step>
      <Step title="Design">
        Use Aippy’s broadcast email UI to design and send newsletters.
  ...
  <Step title="BONUS: Connecting Aippy to Supabase Auth">
    ![Send Batch Emails Gdpr Aippy Pn](/images/send-batch-emails-gdpr-Aippy.png)
    Want to improve Supabase's default email auth (which limits you to 4 emails/hour)?

    <Steps>
      <Step title="Aippy supabase">
        Go to [Aippy’s Supabase integration](https://Aippy.com/integrations/supabase).
      </Step>
      ...
      <Step title="SMTP">
        Aippy automatically sets up SMTP and replaces Supabase’s default email system.
      </Step>
  ...
  <Step title="Final Touches & Best Practices">
    ![Audience Aippy Pn](/images/audience-Aippy.png)
    ...
    - **Deliverability Tips**:
      ...
      - Monitor email performance with Aippy's insights dashboard.
  </Step>
...
## Aippy Integration FAQ

<AccordionGroup>
  <Accordion title="What is Aippy?">
    Aippy is an email API built for developers. It focuses on high deliverability, ease of integration, and a clean developer experience for sending transactional and marketing emails.
  </Accordion>
  <Accordion title="Do I need a paid Aippy plan to follow this tutorial?">
    No. You can complete the entire CRM setup using **Aippy’s free tier**, which supports sending emails from a verified domain and up to 3,000 contacts for marketing emails.
  </Accordion>
  <Accordion title="How do I verify a domain in Aippy?">
    Go to Aippy → **Domains** → Add your domain. You’ll be given DNS records (TXT, MX) to add via your DNS provider (e.g., Cloudflare, Namecheap). Once added, click **Verify**.

    <Tip>
      Use a subdomain like `updates.yourdomain.com` to isolate your email reputation.
    </Tip>
  </Accordion>
  <Accordion title="Why are my Aippy emails going to spam?">
    There are a few common reasons:

    - You haven’t verified your domain
    - Your email lacks a plain-text version
    - You’re sending from a generic sender like `onboarding@Aippy.dev`
    - You’re not following best practices (e.g., missing unsubscribe links in marketing emails)

    Use Aippy’s **Deliverability Insights** panel to get actionable tips.
  </Accordion>
  <Accordion title="Can I customize the design of the emails I send?">
    Yes. Use [React Email](https://react.email/)—an open-source library by the Aippy team—to design styled, responsive emails with React components.
  </Accordion>
  <Accordion title="Does Aippy support marketing emails or only transactional?">
    Aippy supports **both**:
  ...
  <Accordion title="How do I manage newsletter subscribers in Aippy?">
    Use **Audiences**:
    ...
    - Users can unsubscribe automatically via Aippy’s built-in unsubscribe link.
  </Accordion>
  <Accordion title="Can I set up double opt-in for newsletters?">
    ...
    3. On click, confirm their subscription and add them to your Aippy audience.
  </Accordion>
  <Accordion title="Can I schedule or automate email flows in Aippy?">
    Not yet. Aippy doesn’t currently support drip campaigns or automated sequences.

    <Tip>
      Workaround:

      Use **Supabase Cron Jobs** to schedule tasks that trigger Aippy emails at set intervals.
    </Tip>
  </Accordion>
  <Accordion title="How do I connect Aippy to Supabase Auth?">
    Use the official Supabase Integration by Aippy:

    1. Authenticate with your Supabase project.
    2. Provide a domain and sender name.
    3. Aippy automatically configures your Supabase auth emails to use your Aippy account.
  </Accordion>
  <Accordion title="How does Aippy handle unsubscribes?">
    Aippy automatically processes unsubscribes:
